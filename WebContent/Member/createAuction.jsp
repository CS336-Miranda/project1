...
<div class="content">
	<div class="row">
		...
		<div class="col-xs-12 col-lg-9">
			...
			<div class="row subCategoryAttributes laptop" style="display: none;">
				<div class="col-xs-12 col-lg-2">
		  	...
		  	<div class="row subCategoryAttributes cellphone" style="display: none;">
				<div class="col-xs-12 col-lg-2">
					<div class="form-group">
		  	...
		  	<div class="row subCategoryAttributes tv" style="display: none;">
				<div class="col-xs-12 col-lg-2">
					<div class="form-group">
